...
async def _episode_quality_poller(
    ...
    while remaining and (time.time() - start_time) < MAX_POLL_TIME:
        ...
        class _ProxyMsg:
            """
            Channel message mein from_user nahi hota.
            Swift ke _upload_one_file ko user_id chahiye (thumb + session ke liye).
            Isliye original message ko wrap karo aur from_user.id = owner_id set karo.
            """
